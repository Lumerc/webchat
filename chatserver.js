...
const keyFilePath = "/etc/ssl/ssl.crt/kurwabobr.site-key.pem";
const certFilePath = "/etc/ssl/ssl.crt/kurwabobr.site-crt.pem";
...
function handleWebRequest(request, response) {
  ...
  {
      if(splitted[2] == 'chat.css')
      {
          response.writeHead(200);
          fs.readFile('assets/chat.css', (error, data) => response.end(data));
      }
      else if(splitted[2] == 'adapter.js')
      {
          response.writeHead(200);
          fs.readFile('assets/adapter.js', (error, data) => response.end(data));
      }
      else if(splitted[2] == 'chatclient.js?v1')
      {
          response.writeHead(200);
          fs.readFile('assets/chatclient.js', (error, data) => response.end(data));
      }
      else if(splitted[2] == 'bootstrap.min.css?v1')
      {
          response.writeHead(200);
          fs.readFile('assets/bootstrap.min.css', (error, data) => response.end(data));
      }
      else if(splitted[2] == 'font-awesome.all.css')
      {
          response.writeHead(200);
          fs.readFile('assets/font-awesome.all.css', (error, data) => response.end(data));
      }
      else if(splitted[2] == 'jquery-3.2.1.slim.min.js')
      {
          response.writeHead(200);
          fs.readFile('assets/jquery-3.2.1.slim.min.js', (error, data) => response.end(data));
      }
      else if(splitted[2] == 'popper.min.js')
      {
          response.writeHead(200);
          fs.readFile('assets/popper.min.js', (error, data) => response.end(data));
      }
      else if(splitted[2] == 'bootstrap.min.js')
      {
          response.writeHead(200);
          fs.readFile('assets/bootstrap.min.js', (error, data) => response.end(data));
      }
      else if(splitted[2] == 'fontawesome-webfont.woff2')
      {
          response.writeHead(200);
          fs.readFile('assets/fontawesome-webfont.woff2', (error, data) => response.end(data));
      }
      else if(splitted[2] == 'fa-solid-900.woff2')
      {
          response.writeHead(200);
          fs.readFile('assets/fa-solid-900.woff2', (error, data) => response.end(data));
      }
      else
      {
  ...
  {
      response.writeHead(200);
      fs.readFile("pages/name.html", (error, data) => response.end(data));
  }
  else
  {
      response.writeHead(200);
      fs.readFile("pages/chat.html", (error, data) => response.end(data));
  }
...
webServer.listen(3030, function() {
  log("Server is listening on port 3030");
});
